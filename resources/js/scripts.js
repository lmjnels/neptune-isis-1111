(function ($) {
    ...
    function pageLoader()
    {
        ...
        console.log('pageLoader', 'script.js', 'siteLoader', siteLoader)
        console.log('siteHeader has classic_menu', siteHeader.hasClass('classic_menu'))
        ...
        if (siteLoader == true) {
            ...
            console.log('aplCount', aplCount)


            console.log('num1wrap', num1wrap)
    ...
    function aliothRecentWorks() {
        ...
        console.log('recentWorkCarousel', '$this', $this)
